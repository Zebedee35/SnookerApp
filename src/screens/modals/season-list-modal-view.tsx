...
const SeasonListModalView: FC<TSeasonListModalViewProps> = ({
  modalVisible,
  dataList,
  onSeasonSelected,
  setModalVisible,
  ...
  return (
    <Modal animationType="fade" transparent visible={modalVisible} onRequestClose={() => {}}>
      <Box style={styles.centeredView}>
        <Pressable
          style={styles.tapFrame}
          activeOpacity={1}
          onPress={() => {
            setModalVisible(!modalVisible);
          }}>
          <Box style={styles.modalView}>
            <Label textType="bold" style={styles.modalText}>
              Season List
            </Label>
            <FlatList
              data={dataList}
              ...
              renderItem={({item}) => (
                <TouchableOpacity style={{height: 40}} onPress={() => onSeasonSelected(item)}>
