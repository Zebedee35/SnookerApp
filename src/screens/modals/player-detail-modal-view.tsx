...
const PlayerDetailModalView: FC<TPlayerDetailModalViewProps> = ({
  modalVisible,
  setModalVisible,
  player,
  children,
  ...
  const getLatestMatches = async (id: string) => {
    try {
        ...
        <Box style={styles.content}>
          ...
          <Box style={styles.header}>
            <Box style={styles.sideBox}>
              ...
              <Label textType="bold" style={styles.value}>
                {player?.rank}
              </Label>
          ...
          <Label textType="bold" style={styles.playerName}>
            {player?.name}
          </Label>
          ...
          <SectionList
            ...
            renderSectionHeader={({section: {eventName}}) => <SimpleListHeader text={eventName} />}
